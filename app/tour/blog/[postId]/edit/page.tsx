...
export default function TourBlogEditPage({
  params,
}: {
  ...
  const { posts, getById, upsert } = useBlogPosts({ dataUserId: PUBLIC_OWNER_UID });
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-600">
              {readOnly ? "운영자만 편집할 수 있어요." : "수정 후 저장하면 바로 반영돼요."}
            </p>
            <div className="mt-2">
              <Link
                href={`/tour/blog/${postId}`}
